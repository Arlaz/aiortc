...
DEFAULT_BITRATE = 20_000_000  # 500 kbps
MIN_BITRATE = 250_000  # 250 kbps
MAX_BITRATE = 15_000_000  # 1.5 Mbps
...
class Vp8Encoder(Encoder):
    ...
    def encode(
        ...
        if self.codec is None:
            ...
            self.codec.gop_size = 3000  # allow large GOPs to cut overhead

            # quantizer bounds (quality envelope)
            self.codec.qmin = 4  # don’t let quality collapse
            self.codec.qmax = 56  # allow high compression when needed
